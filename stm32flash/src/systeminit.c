...
void systeminit(void){
    ...
    TIM2->SMCR |=0b0011;                    // Encoder mode 1 - Counter counts up/down on TI1FP1 edge depending on TI2FP2  level. Consider trigger selection to sync counter.
    ...
    TIM2->DIER |= 10;
    TIM2->CR1 |=10000001;                  // Enable TIM2 Counter
