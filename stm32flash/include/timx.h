...
typedef struct{
    ...
    volatile uint32_t EGR;      //0x14
    volatile uint32_t CCMR1;    //0x18
    volatile uint32_t RESERVE2; //0x1C
    volatile uint32_t CCER;     //0x20
    volatile uint32_t CNT;      //0x24
    volatile uint32_t PSC;      //0x28
    volatile uint32_t ARR;      //0x2C
    volatile uint32_t RCR;      //0x30
    volatile uint32_t CCR1;     //0x34
    volatile uint32_t RESERVE3; //0x38
    volatile uint32_t RESERVE4; //0x3C
    volatile uint32_t RESERVE5; //0x40
    volatile uint32_t BDTR;     //0x44
    volatile uint32_t DCR;      //0x48
    volatile uint32_t DMAR;     //0x4C
    volatile uint32_t OR;       //0x50
...
#define TIM2  ((Gen_TIM_TypeDef1 *) 0x40000000)
#define TIM3  ((Gen_TIM_TypeDef1 *) 0x40000400)
#define TIM4  ((Gen_TIM_TypeDef1 *) 0x40000800)
#define TIM15 ((Gen_TIM_TypeDef1 *) 0x40014000)
#define TIM16 ((Gen_TIM_TypeDef2 *) 0x40014400)
#define TIM17 ((Gen_TIM_TypeDef2 *) 0x40014800)
